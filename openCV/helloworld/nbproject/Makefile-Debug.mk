...
LDLIBSOPTIONS=-Wl,-rpath,'../OpenCV/opencv-2.4.13/include/opencv2'
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../OpenCV/opencv-2.4.13/include/opencv2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
