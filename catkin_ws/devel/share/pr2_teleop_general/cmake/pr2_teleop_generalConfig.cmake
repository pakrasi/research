...
if(NOT "/home/pakrasi/catkin_ws/src/pr2_apps/pr2_teleop_general/include " STREQUAL " ")
  set(pr2_teleop_general_INCLUDE_DIRS "")
  set(_include_dirs "/home/pakrasi/catkin_ws/src/pr2_apps/pr2_teleop_general/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_teleop_general' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pakrasi/catkin_ws/src/pr2_apps/pr2_teleop_general/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
